This file defines a React component for rendering a single command item in a command menu. It handles selection, keyboard shortcuts, scrolling into view, checkboxes, and supports both custom anchor components and standard links.
